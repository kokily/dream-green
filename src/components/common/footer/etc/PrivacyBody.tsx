      ...
      <div className="text-dark mb-1">
        ...
        <blockquote className="blockquote">
          <p className="text-dark mb-0">
            - 파기 절차: 꿈에그린환경은 파기하여야 하는 개인정보(또는
            개인정보파일)의 처리목적이 달성된 경우 또는 보유기간이 경과한 경우
            개인정보 보호책임자의 책임 하에 내부방침에 따라 파기합니다.
          </p>
          <p className="text-dark mb-0">
            - 파기 방법: 꿈에그린환경은 전자적 개인정보파일은 재생할 수 없는
            기술적 방법을 사용햐여 파기하며, 비전자 개인정보파일은 분쇄기로 분쇄
            및 소각하여 파기합니다.
          </p>
        </blockquote>
      </div>
  ...
  const Sixth = (
    <>
      ...
      <div className="text-dark mb-1">
        ...
        <blockquote className="blockquote">
          <p className="text-dark mb-0">
            1. 개인정보취급자 최소화 교육 : 개인정보를 취급하는 직원은 반드시
            필요한 인원에 한하여 지정·관리하고 있으며, 취급자를 대상으로 안전한
            관리를 위한 교육을 실시하고 있습니다.
          </p>
          <p className="text-dark mb-0">
            2. 개인정보에 대한 접근통제 : 개인정보처리시스템에 대한 접근권한의
            부여·변경·말소를 통하여 개인정보에 대한 접근통제를 위해 필요한
            조치를 하고 있으며 침입 차단 시스템을 이용하여 외부로부터 무단
            접근을 통제하고 있습니다.
          </p>
          <p className="text-dark mb-0">
            3. 접속기록의 보관 : 개인정보처리시스템에 접속한 기록을 최소 1년
            이상 보관·관리하고 있습니다.
          </p>
          <p className="text-dark mb-0">
            4. 개인정보의 암호화 : 개인정보는 암호화를 통해 안전하게 저장 및
            관리되고 있습니다. 또한 중요한 데이터는 저장 및 전송시 암호화하여
            사용하는 등 별도 보안 기능을 사용하고 있습니다.
          </p>
          <p className="text-dark mb-0">
            5. 보안프로그램 설치 및 주기적 점검·갱신 : 해킹이나 컴퓨터 바이러스
            등에 의한 개인정보 유출 및 훼손을 막기 위하여 보안 프로그램을
            설치하고 주기적으로 갱신·점검하고 있습니다.
          </p>
          <p className="text-dark mb-0">
            6. 비인가자에 대한 출입 통제 : 개인정보를 보관하고 있는
            개인정보처리시스템의 물리적 보관 장소를 별도로 두고 이에 대한
  ...
  const Seventh = (
    <>
      ...
      <div className="text-dark mb-1">
        ...
        <blockquote className="blockquote">
          <p className="text-dark mb-0">
            - 쿠키의 사용 목적 : 이용자가 방문한 각 서비스와 웹사이트들에 대한
            방문 및 이용형태, 인기검색어, 보안접속 여부 등을 파악, 이용자에게
      ...
      <div className="text-dark mb-1">
        ...
        <blockquote className="blockquote">
          ...
          <p className="text-dark mb-0">
            ...
            &nbsp;&nbsp;부서명 : 꿈에그린환경 경영지원부
            <br />
            &nbsp;&nbsp;전화번호/팩스번호 : 031)831-8852 / 031)831-8853
            <br />
